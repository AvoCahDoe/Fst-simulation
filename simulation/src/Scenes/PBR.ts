import { Scene , Engine, FreeCamera, Vector3, HemisphericLight, MeshBuilder,CubeTexture } from "babylonjs";
...
export class PBR {
    ...
    CreateScene():Scene{
        ...
        const envTex = CubeTexture.CreateFromPrefilteredData('./environment/overcast_soil_puresky_2k.env',scene)
